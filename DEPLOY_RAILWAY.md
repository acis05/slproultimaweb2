# Deploy / Update StokLedger Web v1.3.4 di Railway

1. Replace source repo lokal dengan isi ZIP v1.3.4, tetapi jangan hapus folder `.git`.
2. Dari terminal VS Code:
```bash
git add .
git commit -m "Upgrade StokLedger Web v1.3.4 SaaS admin and trial signup"
git push
```
